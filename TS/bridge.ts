...
export function show(): void {
	var abstractionA: BridgePattern.Abstraction = new BridgePattern.RefinedAbstractionA(
		new BridgePattern.ConcreteImplementorA()
	)
	var abstractionB: BridgePattern.Abstraction = new BridgePattern.RefinedAbstractionB(
